export const content = {
  es: {
    ...
    about: {
      title: "Nosotros",
      description: "Casa de Bamba nació del sueño de crear un espacio donde el arte, la música y la buena compañía se encuentran. En el corazón de un barrio de artistas, decidimos construir más que un bar: un encuentro de almas que buscan compartir momentos auténticos.",
      ...
      impact: "Hoy, Casa de Bamba es el corazón de nuestra comunidad. La vibra que recibimos de ustedes, nuestros clientes, es la gasolina que nos mantiene vivos. Cada risa, cada brindis, cada encuentro aquí es lo que nos inspira a seguir adelante.",
    ...
    offer: {
      ...
      tapas: "Tapas",
      tapasDesc: "Pequeños placeres que acompañan perfectamente tu experiencia en Casa de Bamba."
    },
    contact: {
      title: "Contacto",
      phone: "Teléfono",
  ...
  en: {
    ...
    about: {
      title: "About Us",
      description: "Casa de Bamba was born from the dream of creating a space where art, music, and good company meet. In the heart of an artist neighborhood, we decided to build more than a bar: a gathering of souls seeking to share authentic moments.",
      ...
      impact: "Today, Casa de Bamba is the heartbeat of our community. The vibe we receive from you, our customers, is the fuel that keeps us alive. Every laugh, every toast, every encounter here is what inspires us to keep going.",
    ...
    offer: {
      ...
      tapas: "Tapas",
      tapasDesc: "Little pleasures that perfectly complement your experience at Casa de Bamba."
    },
    contact: {
      title: "Contact",
      phone: "Phone",
